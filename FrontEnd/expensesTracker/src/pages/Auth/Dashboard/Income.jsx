...
const Income = () => {
  ...
  const [OpenAddIncomeMode, setOpenAddIncomeMode] = useState (false);
  ...
  const handleAddIncome = async (income) => { 
    ...
    try{
      ...
      console.error("Error while adding the Income",
  ...
  const deleteIncome = async (id) => {
    try {
  await axiosInstance.delete(API_PATHS.INCOME.DELETE_ALL_INCOME(id));
